  ...
  function parseCSV(text) {
    ...
    return lines
      ...
      function highlightActivePill(id) {
        ...
        pills.forEach((pill) => {
          const isActive = pill.dataset.id === id;
          if (isActive) {
            pill.classList.remove("bg-white", "text-slate-700", "border-slate-300");
            pill.classList.add("bg-emerald-500", "text-white", "border-emerald-600", "shadow-md");
          } else {
            pill.classList.remove("bg-emerald-500", "text-white", "border-emerald-600", "shadow-md");
      ...
      function populatePills(nodes) {
        ...
        nodes.forEach((node) => {
          ...
          pill.className = "pill px-4 py-2 rounded-lg border border-slate-300 bg-white text-slate-700 text-sm font-medium hover:bg-slate-50 hover:border-slate-400 active:bg-slate-100 transition-colors duration-150 cursor-pointer shadow-sm";
